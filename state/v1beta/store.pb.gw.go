...
func RegisterStateStoreServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StateStoreServiceServer) error {
	mux.Handle(http.MethodPost, pattern_StateStoreService_GetState_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle(http.MethodPost, pattern_StateStoreService_SetState_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodPost, pattern_StateStoreService_DelState_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
...
// "StateStoreServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
