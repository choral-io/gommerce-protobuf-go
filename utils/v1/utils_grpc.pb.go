...
func (c *sequenceServiceClient) NextValue(ctx context.Context, in *NextValueRequest, opts ...grpc.CallOption) (*NextValueResponse, error) {
	...
	err := c.cc.Invoke(ctx, SequenceService_NextValue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSequenceServiceServer) NextValue(context.Context, *NextValueRequest) (*NextValueResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NextValue not implemented")
}
...
func (c *snowflakeServiceClient) NextHex(ctx context.Context, in *NextHexRequest, opts ...grpc.CallOption) (*NextHexResponse, error) {
	...
	err := c.cc.Invoke(ctx, SnowflakeService_NextHex_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *snowflakeServiceClient) NextInt64(ctx context.Context, in *NextInt64Request, opts ...grpc.CallOption) (*NextInt64Response, error) {
	...
	err := c.cc.Invoke(ctx, SnowflakeService_NextInt64_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSnowflakeServiceServer) NextHex(context.Context, *NextHexRequest) (*NextHexResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NextHex not implemented")
}
func (UnimplementedSnowflakeServiceServer) NextInt64(context.Context, *NextInt64Request) (*NextInt64Response, error) {
	return nil, status.Error(codes.Unimplemented, "method NextInt64 not implemented")
}
...
func (c *passwordServiceClient) GeneratePassword(ctx context.Context, in *GeneratePasswordRequest, opts ...grpc.CallOption) (*GeneratePasswordResponse, error) {
	...
	err := c.cc.Invoke(ctx, PasswordService_GeneratePassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *passwordServiceClient) HashPassword(ctx context.Context, in *HashPasswordRequest, opts ...grpc.CallOption) (*HashPasswordResponse, error) {
	...
	err := c.cc.Invoke(ctx, PasswordService_HashPassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *passwordServiceClient) ValidatePassword(ctx context.Context, in *ValidatePasswordRequest, opts ...grpc.CallOption) (*ValidatePasswordResponse, error) {
	...
	err := c.cc.Invoke(ctx, PasswordService_ValidatePassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DateTimeServiceClient interface {
	...
	WatchLocalNow(ctx context.Context, in *WatchLocalNowRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WatchLocalNowResponse], error)
}
...
func (c *dateTimeServiceClient) GetDBNow(ctx context.Context, in *GetDBNowRequest, opts ...grpc.CallOption) (*GetDBNowResponse, error) {
	...
	err := c.cc.Invoke(ctx, DateTimeService_GetDBNow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dateTimeServiceClient) GetRedisNow(ctx context.Context, in *GetRedisNowRequest, opts ...grpc.CallOption) (*GetRedisNowResponse, error) {
	...
	err := c.cc.Invoke(ctx, DateTimeService_GetRedisNow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dateTimeServiceClient) GetUTCNow(ctx context.Context, in *GetUTCNowRequest, opts ...grpc.CallOption) (*GetUTCNowResponse, error) {
	...
	err := c.cc.Invoke(ctx, DateTimeService_GetUTCNow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dateTimeServiceClient) GetLocalNow(ctx context.Context, in *GetLocalNowRequest, opts ...grpc.CallOption) (*GetLocalNowResponse, error) {
	...
	err := c.cc.Invoke(ctx, DateTimeService_GetLocalNow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dateTimeServiceClient) WatchLocalNow(ctx context.Context, in *WatchLocalNowRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WatchLocalNowResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DateTimeService_ServiceDesc.Streams[0], DateTimeService_WatchLocalNow_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[WatchLocalNowRequest, WatchLocalNowResponse]{ClientStream: stream}
...
type DateTimeService_WatchLocalNowClient = grpc.ServerStreamingClient[WatchLocalNowResponse]
...
type DateTimeServiceServer interface {
	...
	WatchLocalNow(*WatchLocalNowRequest, grpc.ServerStreamingServer[WatchLocalNowResponse]) error
...
func (UnimplementedDateTimeServiceServer) GetDBNow(context.Context, *GetDBNowRequest) (*GetDBNowResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDBNow not implemented")
}
func (UnimplementedDateTimeServiceServer) GetRedisNow(context.Context, *GetRedisNowRequest) (*GetRedisNowResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRedisNow not implemented")
}
func (UnimplementedDateTimeServiceServer) GetUTCNow(context.Context, *GetUTCNowRequest) (*GetUTCNowResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUTCNow not implemented")
}
func (UnimplementedDateTimeServiceServer) GetLocalNow(context.Context, *GetLocalNowRequest) (*GetLocalNowResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLocalNow not implemented")
}
func (UnimplementedDateTimeServiceServer) WatchLocalNow(*WatchLocalNowRequest, grpc.ServerStreamingServer[WatchLocalNowResponse]) error {
	return status.Error(codes.Unimplemented, "method WatchLocalNow not implemented")
}
...
func RegisterDateTimeServiceServer(s grpc.ServiceRegistrar, srv DateTimeServiceServer) {
	// If the following call panics, it indicates UnimplementedDateTimeServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _DateTimeService_WatchLocalNow_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DateTimeServiceServer).WatchLocalNow(m, &grpc.GenericServerStream[WatchLocalNowRequest, WatchLocalNowResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DateTimeService_WatchLocalNowServer = grpc.ServerStreamingServer[WatchLocalNowResponse]
